...
def build_candidate_eligibility(
    ...
    masks_and_reasons = [
        ...
        (
            controls["is_original_control"],
            "original_control_already_used_benchmark_only",
        ),
    ]
...
def run_analysis(
    ...
    *,
    ...
    eligible_common = common[
        common["eligible_replacement_candidate"].astype(bool)
    ].copy()
    top_candidate = None if eligible_common.empty else eligible_common.iloc[0]
    output_hashes = {
    ...
    summary = {
        ...
        "top_common_candidate": (
            None if top_candidate is None else top_candidate.to_dict()
        ),
    ...
    write_status(
        ...
        [
            ...
            (
                "top_common_candidate=NONE"
                if top_candidate is None
                else f"top_common_candidate={top_candidate['candidate_control_repo']}"
            ),
