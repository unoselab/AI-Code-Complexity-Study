...
This is the first, outcome-blind stage of the run-py-7f02 experiment. It reads
...
- This script does not estimate treatment effects or inspect confidence
  intervals.
- Function-role groups are not imposed in advance. Observable AST structure and
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("repo_python/run-py-7f02/strict"),
    )
    parser.add_argument(
        "--cache-db",
        type=Path,
...
def scan(args: argparse.Namespace) -> dict[str, Any]:
    ...
    metadata = {
        ...
        "scientific_scope": {
            ...
            "predefined_function_role_taxonomy_applied": False,
            "prior_run_py_7_outcome_outputs_consumed": False,
