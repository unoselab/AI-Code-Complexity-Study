...
# =============================================================================
# run-py-7f15-did-class-method-role-groups-borusyak-v1.sh
# -----------------------------------------------------------------------------
...
#
# Default execution after removing -v1 from the development filenames:
#   bash proc_sh_v2/run-py-7f15-did-class-method-role-groups-borusyak.sh
#
...
echo "Exploratory incomplete models:  ${EXPLORATORY_INCOMPLETE}"
echo "Category 6 interpretation:      exploratory due to 28 bodies in 11 positive months"
echo "Reference period:               -1 (omitted; normalized to zero)"
