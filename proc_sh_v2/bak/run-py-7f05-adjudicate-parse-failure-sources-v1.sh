...
# =============================================================================
# run-py-7f05-adjudicate-parse-failure-sources-v1.sh
# -----------------------------------------------------------------------------
# Purpose:
...
#
# Full run:
#   bash proc_sh_v2/run-py-7f05-adjudicate-parse-failure-sources-v1.sh
#
...
PYTHON_SCRIPT="${PYTHON_SCRIPT:-proc_scripts/adjudicate_parse_failure_sources-v1.py}"
