...
zero-inclusive repo-month quality panel for nine strict file-level ML AGC-share
cutoffs: 0.10, 0.20, ..., 0.90. The function-level SVM decision boundary is
...
- Sensitivity grid: 0.10, 0.20, ..., 0.90
...
STRICT_OPERATOR = ">"
DEFAULT_THRESHOLDS = tuple(round(x / 10, 2) for x in range(1, 10))
